      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:contacto@nutrition-intelligence.com" className="hover:text-white transition">
                  Contacto
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <div className="mt-4 text-center text-sm text-gray-500">
            <p>&copy; {currentYear} Nutrition Intelligence. Todos los derechos reservados.</p>
            <p className="mt-1">Hecho con ❤️ en México</p>
          </div>
        </div>
      </div>
    </footer>
